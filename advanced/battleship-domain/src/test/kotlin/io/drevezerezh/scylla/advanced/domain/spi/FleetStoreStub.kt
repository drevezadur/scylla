...
/**
 * Stub of [FleetStore] for testing purpose
 *
 * This implementation is very simple and does not provide any "protection" such as thread safe
 */
class FleetStoreStub : AbstractItemStoreStub<FleetId, Fleet>(), FleetStore {

    override fun extractId(item: Fleet): FleetId = item.id

    override fun itemAlreadyExists(id: FleetId): Nothing {
        throw FleetNotFoundException(id)
    }
}