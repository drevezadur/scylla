...
interface ShotUseCaseManager {

    /**
     * A shot is performed to the opponent grid
     * @param battleId the battle identifier
     * @param fromPlayerId the firing player
     * @param target the remote fire location
     * @return the report of the shot
     */
    fun shotAt(battleId: BattleUUID, fromPlayerId: PlayerUUID, target: Location): ShotReport
