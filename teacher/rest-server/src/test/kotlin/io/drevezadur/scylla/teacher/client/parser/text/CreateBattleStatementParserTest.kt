...
class CreateBattleStatementParserTest {

    private val statementParser = CreateBattleStatementParser()
    ...
    @ParameterizedTest
    @ValueSource(strings = ["createBattle", "createBattle x", "createBattle x y z"])
    ...
    fun `parse shall accept valid statement`() {
        Assertions.assertThat(statementParser.parse("createBattle John Jane"))
            .extracting("player1Name", "player2Name")
