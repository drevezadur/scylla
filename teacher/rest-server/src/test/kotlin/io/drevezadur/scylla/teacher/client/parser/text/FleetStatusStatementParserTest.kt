...
class FleetStatusStatementParserTest {

    private val statementParser = FleetStatusStatementParser()
    ...
    @ParameterizedTest
    @ValueSource(strings = ["fleetStatus", "fleetStatus x y"])
    ...
    fun `parse shall accept valid statement`() {
        Assertions.assertThat(statementParser.parse("fleetStatus Jane"))
