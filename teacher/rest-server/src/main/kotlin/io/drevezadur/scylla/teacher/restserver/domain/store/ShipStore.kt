...
interface ShipStore {
    ...
    fun create(creation: ShipCreation): ShipDEntity

    fun findById(battleId: BattleUUID, playerId: PlayerUUID, type: ShipType): ShipDEntity?

    fun getAllShipsInFleet(battleId: BattleUUID, playerId: PlayerUUID): List<ShipDEntity>

    fun getAll(): List<ShipDEntity>

    fun delete(battleId: BattleUUID, playerId: PlayerUUID, type: ShipType)

    fun save(ship: ShipDEntity)
